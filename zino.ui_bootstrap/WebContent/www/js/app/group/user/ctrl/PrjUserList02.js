define([
	'text!group/user/tmpl/PrjUser_List02.html', 
	'text!group/user/tmpl/PrjUser_List_Content02.html', 
	], function(PrjUser_List02, 
				PrjUser_List_Content02){

	var PrjUserList02 	= function (grpName, header, content, footer) {
		...
		this.do_lc_init		= function(){
			...
			pr_ctr_dashboard			= App.controller.PrjUser.Dashbord
			
			tmplName.PRJ_USER_LIST			= "PrjUser_List02";
			tmplName.PRJ_USER_LIST_CONTENT	= "PrjUser_List_Content02";
		}
		...
		this.do_lc_show = function(div, type01, type02){               
			try{
				...
				console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, pr_ctr_Main.var_lc_URL_Header, App.network, "prj.user", "PrjUserList02", "do_lc_show", e.toString()) ;
			}
		};

		var doLoadView = function(div = "#div_main_content"){	
			tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_USER_LIST					, PrjUser_List02); 
			tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_USER_LIST_CONTENT			, PrjUser_List_Content02);
