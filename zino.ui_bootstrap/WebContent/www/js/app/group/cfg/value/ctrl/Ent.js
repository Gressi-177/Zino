define([
		...
		var CtrlEnt     = function (grpName, header, content, footer) {
			...
			this.do_lc_init		= function(){
				...
				if (!App.controller[pr_grpName].EntTabValue	)  
					 App.controller[pr_grpName].EntTabValue		= new CtrlEntTabValue		(null, "#div_Ent_TabValue", null, pr_grpName);
				
				App.controller[pr_grpName].EntBtn		.do_lc_init();
				App.controller[pr_grpName].EntHeader	.do_lc_init();
				App.controller[pr_grpName].EntTabValue	.do_lc_init();
				//--------------------------------------------------------------------
				...
				pr_ctr_EntTabValue 		= App.controller[pr_grpName].EntTabValue;
