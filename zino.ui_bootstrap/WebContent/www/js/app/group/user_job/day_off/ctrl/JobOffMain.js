define([
        ...
        'text!group/user_job/day_off/tmpl/JobOff_Main.html',
        
        'group/user_job/day_off/ctrl/JobOffList',
        'group/user_job/day_off/ctrl/JobOffEnt',
        'group/user_job/day_off/ctrl/JobOffEntHeader',
        'group/user_job/day_off/ctrl/JobOffEntBtn',
        'group/user_job/day_off/ctrl/JobOffEntTabs',       
        'group/user_job/day_off/ctrl/JobOffEntTabDetail',
        'group/user_job/day_off/ctrl/JobOffEntTabDoc',
        'group/user_job/day_off/ctrl/JobOffRights'
...
//		RIGHT ACTION----------------------------------------
		...
		this.do_lc_init		= function(){
			...
			tmplName.JOB_OFF_LIST_REQUEST_PENDING_HEADER 	= "JobOff_List_Request_Pending_Header";
			tmplName.JOB_OFF_LIST_REQUEST_PENDING_CONTENT 	= "JobOff_List_Request_Pending_Content";
			tmplName.JOB_OFF_LIST_REQUEST_VALIDATED_HEADER 	= "JobOff_List_Request_Validated_Header";
			tmplName.JOB_OFF_LIST_REQUEST_VALIDATED_CONTENT = "JobOff_List_Request_Validated_Content";
		...
		//---------------------------------------------------------------------------------------------
		var pr_grpPath 		= 'group/user_job/day_off';
		var pr_showed		= false;
