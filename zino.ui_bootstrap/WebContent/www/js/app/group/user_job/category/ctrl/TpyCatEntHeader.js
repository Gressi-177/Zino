define([
	'jquery',
	'text!group/user_job/category/tmpl/TpyCat_Ent_Header.html'
	...
	var TpyCatEntHeader     = function (grpName, header, content, footer) {
		...
		this.do_lc_show		= function(obj, mode){
			...
			try{
				...
				console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, pr_ctr_Main.var_lc_URL_Header, App.network, "tpy.cat", "TpyCatEntHeader", "do_lc_show", e.toString()) ;
			}
		};
