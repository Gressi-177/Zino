define([
        ...
        'text!group/user_job/category/tmpl/TpyCat_Main.html',
        'text!group/user_job/category/tmpl/TpyCat_List.html',
        
        'group/user_job/category/ctrl/TpyCatList',
        'group/user_job/category/ctrl/TpyCatEnt',
        'group/user_job/category/ctrl/TpyCatEntHeader',
        'group/user_job/category/ctrl/TpyCatEntBtn',
        'group/user_job/category/ctrl/TpyCatRights' 
        ],
        function($,         		
        		TpyCat_Main,
        		TpyCat_List,
	...
	var TpyCatMain 	= function (grpName, header, content, footer) {
		...
		this.do_lc_init		= function(){
			...
			if (!App.controller.TpyCat.List			)  
				 App.controller.TpyCat.List			= new TpyCatList			("#div_TpyCat_List", "#div_TpyCat_List_Header", "#div_TpyCat_List_Content");				
			if (!App.controller.TpyCat.Ent			)  
				 App.controller.TpyCat.Ent			= new TpyCatEnt				(null, "#div_TpyCat_Ent", null);
			if (!App.controller.TpyCat.EntBtn		)  
				 App.controller.TpyCat.EntBtn		= new TpyCatEntBtn			(null, "#div_TpyCat_Ent_Btn", null);
			if (!App.controller.TpyCat.EntHeader	)  
				 App.controller.TpyCat.EntHeader	= new TpyCatEntHeader		(null, "#div_TpyCat_Ent_Header", null);
...
//				App.controller.TpyCat.List	.do_lc_show();
				...
				App.controller.UI.Main.do_bind_event_btn_vertical_list('#div_TpyCat_List', '#div_TpyCat_Ent');
				App.controller.UI.Main.do_lc_bind_event_resize();
				App.controller.UI.Main.do_lc_bind_event_minimize('#div_TpyCat_List', '#div_TpyCat_Ent');
