define([
        ...
        'text!group/user_job/category/tmpl/TpyCat_Project_Report_List_Content.html'
        ],
        function($, 
        		TpyCat_List,
...
//				do_get_list_ByAjax(div, parTyp);
		...
		function do_get_list_ByAjax_Dyn(div, parTyp, varname){	
			var ref 			= req_gl_Request_Content_Send(pr_SERVICE_CLASS, "SVTpyCategoryLstDyn");
			if(parTyp)	ref.parTyp = parTyp;
