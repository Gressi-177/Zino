define([
        'jquery',
        'text!group/user_job/day_off_man/tmpl/JobOff_Ent.html',
        'text!group/user_job/day_off_man/tmpl/JobOff_Popup_Deny_Content.html'
        ],
        function($, 
        		JobOff_Ent,JobOff_Popup_Deny_Content) {
