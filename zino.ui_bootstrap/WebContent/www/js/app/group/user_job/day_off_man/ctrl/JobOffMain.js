define([
        ...
        'text!group/user_job/day_off_man/tmpl/JobOff_Main.html',
        
        'group/user_job/day_off_man/ctrl/JobOffList',
        'group/user_job/day_off_man/ctrl/JobOffEnt',
        'group/user_job/day_off_man/ctrl/JobOffEntHeader',
        'group/user_job/day_off_man/ctrl/JobOffEntBtn',
        'group/user_job/day_off_man/ctrl/JobOffEntTabs',       
        'group/user_job/day_off_man/ctrl/JobOffEntTabDetail',
        'group/user_job/day_off_man/ctrl/JobOffEntTabDoc',
        'group/user_job/day_off_man/ctrl/JobOffRights'
	...
	var JobOffMain 	= function (grpName, header, content, footer) {
		...
		var pr_SERVICE_INFOUSER		= "SVJobDayoffRequestInfoUser";
		var pr_SERVICE_LISTUSER		= "SVJobDayoffRequestLstUser";
...
//		RIGHT ACTION----------------------------------------
		...
		this.do_lc_init		= function(){
			...
			tmplName.JOB_OFF_MAIN			= "JobOff_Main";
			tmplName.JOB_OFF_LIST			= "JobOff_List";
			
			
			tmplName.JOB_OFF_LIST_USER_HEADER 				= "JobOff_List_User_Header";
			tmplName.JOB_OFF_LIST_USER_CONTENT 				= "JobOff_List_User_Content";
			tmplName.JOB_OFF_LIST_REQUEST_BY_USER_HEADER	= "JobOff_List_Request_By_User_Header";
			tmplName.JOB_OFF_LIST_REQUEST_BY_USER_CONTENT	= "JobOff_List_Request_By_User_Content";
			tmplName.JOB_OFF_LIST_REQUEST_HEADER 			= "JobOff_List_Request_Header";
			tmplName.JOB_OFF_LIST_REQUEST_CONTENT 			= "JobOff_List_Request_Content";
			
			tmplName.JOB_OFF_ENT					= "JobOff_Ent";
			tmplName.JOB_OFF_ENT_BTN				= "JobOff_EntBtn";
			tmplName.JOB_OFF_ENT_HEADER				= "JobOff_EntHeader";
			tmplName.JOB_OFF_ENT_TABS				= "JobOff_EntTabs";
			tmplName.JOB_OFF_ENT_TAB_DETAIL 		= "JobOff_EntTabDetail";
			tmplName.JOB_OFF_ENT_TAB_DOC			= "JobOff_EntTabDoc";
			
			tmplName.JOB_OFF_POPUP_DENY_CONTENT 			= "JobOff_Popup_Deny_Content";
			...
			if (!App.controller.JobOff.List			)  
				 App.controller.JobOff.List			= new JobOffList			("#div_JobOff_List", "#div_JobOff_List_Header", "#div_JobOff_List_Content");				
			if (!App.controller.JobOff.Ent			)  
				 App.controller.JobOff.Ent			= new JobOffEnt				(null, "#div_JobOff_Ent", null);
			if (!App.controller.JobOff.EntBtn		)  
				 App.controller.JobOff.EntBtn		= new JobOffEntBtn			(null, "#div_JobOff_Ent_Btn", null);
			if (!App.controller.JobOff.EntHeader	)  
				 App.controller.JobOff.EntHeader	= new JobOffEntHeader		(null, "#div_JobOff_Ent_Header", null);
			if (!App.controller.JobOff.EntTabs		)  
				 App.controller.JobOff.EntTabs		= new JobOffEntTabs			(null, "#div_JobOff_Ent_Tabs", null);
			if (!App.controller.JobOff.Rights)	
				 App.controller.JobOff.Rights 		= new JobOffRights		();
			
			//----------tab name----------------------------------------------------------------------------------------
			if (!App.controller.JobOff.EntTabDetail)  
				 App.controller.JobOff.EntTabDetail	= new JobOffEntTabDetail	(null, "#div_JobOff_Ent_Tab_Detail", null);
			if (!App.controller.JobOff.EntTabDoc)  
				 App.controller.JobOff.EntTabDoc	= new JobOffEntTabDoc	(null, "#div_JobOff_Ent_Tab_Doc", null);
			//--------------------------------------------------------------------------------------------------
