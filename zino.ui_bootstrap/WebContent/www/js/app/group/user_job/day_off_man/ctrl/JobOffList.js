define([
	'jquery',
	'text!group/user_job/day_off_man/tmpl/JobOff_List.html',

	'text!group/user_job/day_off_man/tmpl/JobOff_List_Request_By_User_Header.html',  
	'text!group/user_job/day_off_man/tmpl/JobOff_List_Request_By_User_Content.html',

	'text!group/user_job/day_off_man/tmpl/JobOff_List_Request_Header.html',  
	'text!group/user_job/day_off_man/tmpl/JobOff_List_Request_Content.html',
	
	'text!group/user_job/day_off_man/tmpl/JobOff_List_User_Header.html',  
	'text!group/user_job/day_off_man/tmpl/JobOff_List_User_Content.html'
	],
	function($, 
			JobOff_List,
...
//				do_get_list_request_dyn(pr_div_Rq_By_User, null, App.data.user.id);
		...
		function do_get_list_request_dyn(div, stat, uId03 ){	
			var ref 		= req_gl_Request_Content_Send(pr_SERVICE_CLASS, "SVJobDayoffRequestLstDynMan");
			ref["uId03"]	= uId03;
		...
		function do_get_list_user_dyn(div, typeMulti){
			var ref 			= req_gl_Request_Content_Send("ServiceAutUser", "SVAutUserLstDyn");
			
			ref["typeMulti"]	= typeMulti;
			ref["stat"]			= 1; //STAT_ACTIVE
