define([
	'jquery',
	'text!group/user_job/report_man/tmpl/JobReport_Ent.html',
	'text!group/user_job/report_man/tmpl/JobReport_Popup_Note.html',
	'text!group/user_job/report_man/tmpl/JobReport_Popup_Note_Result.html',
	'text!group/user_job/report_man/tmpl/JobReport_Popup_Deny_Content.html'
	],
	function($,
			JobReport_Ent,
...
//			ref['lock_id'] 		= pr_lock.id;
		...
		const do_lc_get_data = (obj) => {
			let ref 		= req_gl_Request_Content_Send_With_Params("ServiceJobReport", "SVJobReportLstByMonth", {"codeReport" : obj.code, "day" : obj.day});	
