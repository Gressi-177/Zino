define([
	'jquery',
	'text!group/user_job/report_man/tmpl/JobReport_Ent_Header.html',
	'text!group/user_job/report_man/tmpl/JobReport_Ent_Header_User_Summary.html',
	'text!group/user_job/report_man/tmpl/JobReport_Display_QR_Code.html'
	],
...
//			})
		...
		function do_get_values(){
			...
			var infoWh = App.data.selectedUser.cfg02;
			if(infoWh){
				var splitTime = infoWh.match(/\d{2}/g);
				wd.sunS = splitTime[0] 	+":"+ splitTime[1];
				wd.sunE = splitTime[2] 	+":"+ splitTime[3];
				wd.monS = splitTime[4] 	+":"+ splitTime[5];
				wd.monE = splitTime[6] 	+":"+ splitTime[7];
				wd.tueS = splitTime[8] 	+":"+ splitTime[9];
				wd.tueE = splitTime[10] +":"+ splitTime[11];
				wd.wedS = splitTime[12] +":"+ splitTime[13];
				wd.wedE = splitTime[14] +":"+ splitTime[15];
				wd.thuS = splitTime[16] +":"+ splitTime[17];
				wd.thuE = splitTime[18] +":"+ splitTime[19];
				wd.friS = splitTime[20] +":"+ splitTime[21];
				wd.friE = splitTime[22] +":"+ splitTime[23];
				wd.satS = splitTime[24] +":"+ splitTime[25];
				wd.satE = splitTime[26] +":"+ splitTime[27];
			}
			return wd;
		}
