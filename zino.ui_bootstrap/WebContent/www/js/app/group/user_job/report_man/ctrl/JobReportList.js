define([
        'jquery',
        'text!group/user_job/report_man/tmpl/JobReport_List.html',
        'text!group/user_job/report_man/tmpl/JobReport_List_Report_Content.html',
        
        'text!group/user_job/report_man/tmpl/JobReport_List_User_Content.html',
        
        'text!group/user_job/report_man/tmpl/JobReport_Config_Working_Day.html'
...
//				}
		...
		function do_get_list_rp_of_user(uId02, stat,div,divTmpl){
			var ref  = req_gl_Request_Content_Send("SVJobReportLstManDyn");
			ref["uId02"] 	= uId02;
			ref["stat"]		= stat;
