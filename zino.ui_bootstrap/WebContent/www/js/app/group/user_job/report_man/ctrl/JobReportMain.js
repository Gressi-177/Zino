define([
        ...
        'text!group/user_job/report_man/tmpl/JobReport_Main.html',
        'text!group/user_job/report_man/tmpl/Job_Report_Config_Working_Day_User.html',
        
        'group/user_job/report_man/ctrl/JobReportList',
        'group/user_job/report_man/ctrl/JobReportEnt',
        'group/user_job/report_man/ctrl/JobReportEntHeader',
        'group/user_job/report_man/ctrl/JobReportEntBtn',
        'group/user_job/report_man/ctrl/JobReportEntTabs',       
        'group/user_job/report_man/ctrl/JobReportEntTabReportDetail',
        'group/user_job/report_man/ctrl/JobReportEntTabDoc',
        'group/user_job/report_man/ctrl/JobReportDateTime',
        'group/user_job/report_man/ctrl/JobReportRights'
...
//		RIGHT ACTION----------------------------------------
		...
		this.do_lc_init		= function(){		
			...
			tmplName.JOB_REPORT_POPUP_NOTE   				= "JobReport_Popup_Note";
			tmplName.JOB_REPORT_POPUP_NOTE_RESULT           = "JobReport_Popup_Note_Result";
			tmplName.JOB_REPORT_POPUP_DENY_CONTENT          = "JobReport_Popup_Deny_Content";
