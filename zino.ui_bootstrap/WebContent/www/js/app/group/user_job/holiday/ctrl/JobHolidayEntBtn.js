define([
        'jquery',
        'text!group/user_job/holiday/tmpl/JobHoliday_Ent_Btn.html'
	...
	var JobHolidayEntBtn     = function (grpName, header, content, footer) {
		...
		this.do_lc_show		= function(obj, mode){
			...
			try{
				...
				console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, this.var_lc_URL_Header, App.network, "job.holiday", "JobHolidayEntBtn", "do_lc_show", e.toString()) ;
			}
		};
		...
		var do_bind_event_btn_del = function(obj){
			...
			$(pr_btn_Del).click(function(){
				var rightCode = pr_ctr_Rights.req_lc_Right(RIGHT_U_D);
				if(rightCode == -1){
