define([
	...
	// 'text!group/prj/test/tmpl/PrjTestUnit_Ent_Tab_Task.html',
	// 'text!group/prj/test/tmpl/PrjTestUnit_EntCreateTask.html',

	// 'text!group/prj/test/tmpl/PrjTestUnit_Ent_Tab_Task_List.html',
	// 'text!group/prj/test/tmpl/PrjTestUnit_Ent_Tab_Task_List_Element.html',

	'text!group/prj/test/tmpl/PrjTestUnit_EntNew.html',

	'text!group/prj/test/tmpl/PrjTestUnit_Ent_Tab_Member_Group.html',
	'text!group/prj/test/tmpl/PrjTestUnit_Ent_Tab_Member_Group_Popup.html'
	],
	function(	
			PrjTestUnit_Ent,
			...
			// PrjTestUnit_Ent_Tab_Task,
			// PrjTestUnit_EntCreateTask,

			// PrjTestUnit_Ent_Tab_Task_List,
			// PrjTestUnit_Ent_Tab_Task_List_Element,

			PrjTestUnit_EntNew,

			PrjTestUnit_Ent_Tab_Member_Group,
			PrjTestUnit_Ent_Tab_Member_Group_Popup
	){
	...
	const pr_SERVICE_EVAL_CLASS	= "ServiceEval";
...
//	const pr_SV_GET_HISTORY_TASK	= "SVLstHistoryTask";
	...
	tmplName.PRJ_TESTUNIT_ENT_TAB_EPIC					= "PrjTestUnit_Ent_Tab_Epic";
	tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER				= "PrjTestUnit_Ent_Tab_Member";
	tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP			= "PrjTestUnit_Ent_Tab_Member_Group";
	tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP_POPUP	= "PrjTestUnit_Ent_Tab_Member_Group_Popup";
	tmplName.PRJ_TESTUNIT_ENT_TAB_TASK					= "PrjTestUnit_Ent_Tab_Task";
	tmplName.PRJ_TESTUNIT_ENT_CREATE_EPIC				= "PrjTestUnit_EntCreateEpic";
	tmplName.PRJ_TESTUNIT_ENT_CREATE_TASK				= "PrjTestUnit_EntCreateTask";
	tmplName.PRJ_TESTUNIT_ENT_TAB_CUSTOMER				= "PrjTestUnit_Ent_Tab_Customer";
	tmplName.PRJ_TESTUNIT_ENT_TAB_EVALUATION			= "PrjTestUnit_Ent_Tab_Evaluation";
	tmplName.PRJ_TESTUNIT_ENT_CUSTOMER_INFO				= "PrjTestUnit_Ent_Customer_Info";
	tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST				= "PrjTestUnit_Ent_Tab_Task_List";
	tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST_ELEMENT		= "PrjTestUnit_Ent_Tab_Task_List_Element";
	tmplName.PRJ_TESTUNIT_ENT_TAB_EPIC_LIST				= "PrjTestUnit_Ent_Tab_Epic_List";
	tmplName.PRJ_TESTUNIT_ENT_TAB_EPIC_LIST_SHOW_CHILD	= "PrjTestUnit_Ent_Tab_Epic_List_Show_Child";
	tmplName.PRJ_TESTUNIT_ENT_CONTENT_PATH				= "PrjTestUnit_Ent_Content_Path";
	tmplName.PRJ_TESTUNIT_ENT_CONTENT_CHECK_LIST		= "PrjTestUnit_Ent_Content_Check_List";
	tmplName.PRJ_TESTUNIT_ENT_NEW						= "PrjTestUnit_EntNew";
	tmplName.PRJ_TESTUNIT_ENT_CONTENT_HISTORY			= "PrjTestUnit_Ent_Content_History";
	tmplName.PRJ_TESTUNIT_ENT_WORKFLOW_VIEW				= "PrjTestUnit_Ent_Workflow_View";
	...
	const PrjTestUnitEntTabTask 	= function (grpName, header, content, footer) {
		...
		const do_lc_load_view = function(prj){
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK				, PrjTestUnit_Ent_Tab_Task);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST			, PrjTestUnit_Ent_Tab_Task_List);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST_ELEMENT	, PrjTestUnit_Ent_Tab_Task_List_Element);
			tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_NEW					, PrjTestUnit_EntNew);

			// $("#div_prj_task")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK, {isViewSprint : pr_isViewSprint}));
			
			if(pr_isViewSprint){
				if(prj.userRole != pr_member_lev_manager) $("#inp_add_task").hide();
			}
		...
		const do_lc_bind_event_header_task = prj => {
			...
			$("#btn_add_task, #btn_add_task_others").off("click").on("click", function(){
				...
				App.MsgboxController.do_lc_show({
					...
					content 	: tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_NEW, {epics : prj.epicInf, epicSelected: prj.id, typ02: pr_TYPE02_TASK, currencys: App.data.currencys}),
					autoclose	: false,
					buttons		: {
						OK: {
		...
		const do_lc_req_autocomplete = (prj) => {
			...
			let reqSelectMember = (item) => {
				...
				// $("#tbody_task").append(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST_ELEMENT, item));
				$(el).blur().val("");
				$("#a_btn_save_task_sprint, #a_btn_cancel_task_sprint").removeClass("hide");
			}

			let options = {
					dataService : [pr_SERVICE_CLASS, "SVTaskListSearch"], fSelect: reqSelectMember, customShowList, grId: prj.grp
			}
		...
		const do_lc_show_ui_task = (prj, tasks) => {
			...
			// $("#tabTask").html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_TASK_LIST, tasks));
		...
		const do_lc_bind_event_tasks_prj = function(prj){
			$(".td-task").off("click").on("click", function(){
				...
				idTask && pr_ctr_Main.do_lc_switch_mobile_or_pc(`view_prj_project_content.html?id=${idTask}`, "VI_MAIN/"+ App.router.part.PRJ_TESTUNIT_ENT, [idTask], '_self');
				return false;
			});
...
//			})
		...
		const do_lc_refresh_task = function(prj, prjId){
			let ref 		= req_gl_Request_Content_Send_With_Params(pr_SERVICE_CLASS, pr_SV_REFRESH_TASK, {id: prj.id, code: prj.code01});			
...
//			let	obj 		= {files:[]};
	...
	var PrjTestUnitEntTabComment 	= function (grpName, header, content, footer) {
		...
		var do_lc_show_prj_comment = function(dataCmts, idPrj, codePrj){
			do_lc_load_view();
...
//			$(".a-delete[data-userid= '" + App.data.user.id +"']").removeClass("d-none");
			...
			do_lc_bind_event_comments_prj(idPrj, codePrj);
			do_lc_bind_event_resize();
		}

		this.do_lc_get_list_comments = function(idPrj, codePrj, reBuild = false){
			let cond 		= {
				id		: idPrj			, code	: codePrj				, reBuild,
				entId	: idPrj			, entTyp: pr_ENTITY_TYPE_PRJ	, forced	: true,
				begin	: pr_POST_BEGIN	, number: pr_POST_NUMBER		, nbLevel	: pr_POST_HAS_SUB,
			}
			...
			var callbackFunct = function(data) {		//data => sharedJson
				do_lc_show_comment_Dyn(data, idPrj, codePrj);
			}
		...
		var do_lc_show_comment_Dyn = function(sharedJson, idPrj, codePrj){
			let data			= {};
			if (can_gl_AjaxSuccess(sharedJson)) {
				data		= sharedJson[App['const'].RES_DATA];
			}

			do_lc_show_prj_comment(data, idPrj, codePrj);
		}

		var do_lc_bind_event_comments_prj = function(idPrj, codePrj){
			$("#btn_send_comment").off("click").on("click", function(){
				...
				do_lc_send_comment(comment, iParent, idPrj, codePrj);
			})
			...
			$(".a-delete").off("click").on("click", function(){
				let{id} = $(this).data();
				if(id)	do_lc_delete_comment(id, idPrj, codePrj);
			})
		...
		var do_lc_send_comment = function(comment, iParent, idPrj, codePrj){
			let cond 		= {
				id	: idPrj, 
				code: codePrj,
				comment,
			...
			let fSucces		= [];
			fSucces.push(req_gl_funct(null, do_lc_afterSend_cmts, [idPrj, codePrj]));

			let fError 		= req_gl_funct(App, do_gl_show_Notify_Msg_Error, [$.i18n("common_err_ajax")]);	
			App.network.do_lc_ajax_background(App.path.BASE_URL_API_PRIV, App.data["HttpSecuHeader"], ref, 100000, fSucces, fError);
		}

		var do_lc_afterSend_cmts = function(sharedJson, idPrj, codePrj){
			if(can_gl_AjaxSuccess(sharedJson)) {	
				let data = sharedJson[App['const'].RES_DATA];
				data && self.do_lc_get_list_comments(idPrj, codePrj, true);
			}else{
				do_gl_show_Notify_Msg_Error ($.i18n('common_err_msg_save'));
			}
		}
		
		var do_lc_delete_comment = function(idCmt, idPrj, codePrj){
			let cond 		= {"id": idCmt};
			let ref 		= req_gl_Request_Content_Send_With_Params("ServiceNsoPost" , "SVNsoPostDel12H", cond);

			let fSucces		= [];
			fSucces.push(req_gl_funct(null, do_lc_afterDelete_cmts, [idCmt, idPrj, codePrj]));

			let fError 		= req_gl_funct(App, do_gl_show_Notify_Msg_Error, [$.i18n("common_err_ajax")]);	
			App.network.do_lc_ajax_background(App.path.BASE_URL_API_PRIV, App.data["HttpSecuHeader"], ref, 100000, fSucces, fError);
		}

		var do_lc_afterDelete_cmts = function(sharedJson, idCmt, idPrj, codePrj){
			if(can_gl_AjaxSuccess(sharedJson)) {	
				self.do_lc_get_list_comments(idPrj, codePrj, true);
	...
	var PrjTestUnitEntTabContent 	= function (grpName, header, content, footer) {
		...
		const do_lc_getPrjParent_response = (sharedJson, id, parent) => {
			if(can_gl_AjaxSuccess(sharedJson)) {
				...
				if(data && Array.isArray(data) && data.length){
					...
					if(parObj) {
						const url = "view_prj_test_unit.html?id=#id&code=#code".replace("#code", parObj.code01).replace("#id", parObj.id)
						const route = "VI_MAIN/prj_test_unit"
						
						$("#btn_back").data("url", url).data("route", route)
					}
		...
		const do_lc_show_path = prjAll => {
			$("#div_prj_path").html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_PATH, prjAll));
		}
		//------------------------------Start content prj-----------------------------------
		var do_lc_load_view = function(){
			tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT				, PrjTestUnit_Ent_Content);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_PATH			, PrjTestUnit_Ent_Content_Path);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_CHECK_LIST	, PrjTestUnit_Ent_Content_Check_List);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_HISTORY		, PrjTestUnit_Ent_Content_History);
			// tmplCtrl.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_WORKFLOW_VIEW			, PrjTestUnit_Ent_Workflow_View);
...
//			dataWF = do_lc_show_wf_task(prj);
		...
		var do_lc_show_content = function(prj, mode){
			...
			if(prj.typ01 == pr_TYPE01_BUISINESS){
				App.controller.PrjTestUnit.EntCustomer.do_lc_get_list_customers(prj.id);
			} else {
		...
		const do_lc_show_checkList = (prj) => {
			...
			$("#div_check_list").html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_CHECK_LIST, prj));
...
//			do_gl_init_pagination_opt(opt);
		...
		const do_lc_show_listHistory = function(data){
			data = data.reverse();
			$("#div_history_list").html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_CONTENT_HISTORY , data));
		}
		...
		const do_lc_show_prj = (sharedJson, prj) => {
			if(can_gl_AjaxSuccess(sharedJson)) {	
				let data = sharedJson[App['const'].RES_DATA];
				pr_ctr_Main.do_lc_switch_mobile_or_pc(`view_prj_project_content.html?id=${data.id}&code=${data.code01}`, "VI_MAIN/"+ App.router.part.PRJ_TESTUNIT_ENT, [data.id], '_self');
			}else{
				do_gl_show_Notify_Msg_Error ($.i18n('common_err_msg_save'));
			}
		}
...
//						newPrj.files	= newPrj.files.concat(obj.files);
	...
	//------------------------------Start Member list-----------------------------------
	var PrjTestUnitEntTabMemberGroup 	= function (grpName, header, content, footer) {
		//------------------------------Start list member-----------------------------------
		...
		var do_lc_load_view = function(){
			tmplCtrl				.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP				, PrjTestUnit_Ent_Tab_Member_Group);
			tmplCtrl				.do_lc_put_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP_POPUP		, PrjTestUnit_Ent_Tab_Member_Group_Popup);
		}
...
//			pr_GROUP_TEMP = $.extend(false, {}, allMembers);
			...
			$(".show_mem_group").off("click").on("click", function(){
				...
				App.MsgboxController.do_lc_show({
					...
					content 	: tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP_POPUP, memGroup),	
					autoclose	: false,
					buttons		: {
						Ok: {
							lab		:  $.i18n("common_btn_ok"),
...
//				do_lc_show_prj_member(members, prj);
		...
		var do_lc_show_prj_member = function(allMembers, prj){
			do_lc_load_view();
			$("#div_prj_member_group")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_TESTUNIT_ENT_TAB_MEMBER_GROUP		, allMembers));
...
//		}
	...
	return { PrjTestUnitEntTabTask, PrjTestUnitEntTabMember,  PrjTestUnitEntTabDoc, PrjTestUnitEntTabComment, PrjTestUnitEntTabContent, PrjTestUnitEntTabMemberGroup};
});