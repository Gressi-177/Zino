...
public class TaTpyRelationship extends EntityAbstract<TaTpyRelationship> {
	...
	public static final	int		LEV_REPORTER			= 1;
	public static final	int		LEV_MEMBER				= 2;
	public static final	int		LEV_VIEWER				= 3;
	...
	public static List<TaTpyRelationship> reqList (int entTyp01,  Set<Integer> entId01, int entTyp02, Integer entId02, Criterion...cris) throws Exception{
		...
		if (entId02!=null) cri = Restrictions.and (cri, Restrictions.eq(TaTpyRelationship.ATT_I_ENTITY_ID_02	, entTyp02));
	...
	public static List<TaTpyRelationship> reqListMod(int entTyp01, Integer entId01, int entTyp02, Integer entId02,  JSONArray lstJson) throws Exception {
