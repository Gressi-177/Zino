...
public class TaNsoGroupMember extends EntityAbstract<TaNsoGroupMember> {
	...
	public static final int TYP_MANAGER 	= 0;
	public static final int TYP_REPORTER 	= 1;
	public static final int TYP_WORKER 		= 2;
	public static final int TYP_OWNER 		= 10;
	...
	public static List<TaNsoGroupMember> reqListByGroupIdAndDate(Integer grpID, Date dtBegin, Date dtEnd) throws Exception {
		if (grpID==null )					return null;

		List	<TaNsoGroupMember>  	lstObj = TaNsoGroupMember.DAO.reqList(Restrictions.and(
																	Restrictions.eq(TaNsoGroupMember.ATT_I_NSO_GROUP, grpID),
																	Restrictions.ge(TaNsoGroupMember.ATT_D_DATE_01, dtBegin),
	...
	public static List<TaNsoGroupMember> reqListNew (Integer grpID,  JSONArray lstJson) throws Exception {
		...
		for (Object o : lstJson) {
			...
			if(stat == null) inf.reqSet(TaNsoGroupMember.ATT_I_STATUS, TaNsoGroupMember.STAT_NEW);
